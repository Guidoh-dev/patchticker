...
|---|---:|---:|---|---|---|
| GOG GALAXY 2.1.8.30 (2026-08-06) | 2.1.8.30 | 8.1/10 | positive | install candidate | [GOG GALAXY Installer Manifest](https://remote-config.gog.com/components/webinstaller?component_version=2.0.0) |
...
- Local rating test: 8.1/10 (positive) — install candidate
