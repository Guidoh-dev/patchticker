...
- ID: `steam-3-8-25`
- Date: 2026-08-08
- Stored PatchTicker score/status: 3.9 / avoid
- Local rating test: 4.3/10 (negative) — avoid or wait
...
- Rating test notes: Beta/preview channel language detected. 2 risk factor(s) attached. 1 known issue(s) attached.
